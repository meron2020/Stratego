...
class HTTPHandler:
    ...
    def send_request(self, endpoint, params, req_type = None):
        address = self.server_address + endpoint
        try:
            if req_type == "g":
    ...
    def get_board(self, game_id):
        ...
        return self.send_request("/games", params, "g")
    ...
    def join_game(self, game_id, player_id):
        ...
        return self.send_request("/games", params, "p")

    def quit_game(self, game_id, player_id):
        params = {"game_id": game_id, "player_id": player_id}
        return self.send_request("/games", params, "d")
    ...
    def send_starting_positions(self, game_id, pieces_to_pos_dict):
        ...
        return self.send_request("/games", params)
